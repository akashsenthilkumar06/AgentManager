...
- Standalone multi-page React/Vite control plane with dedicated Workspace, Managed agents, Activity, and System health routes
...
| Route | Purpose |
|---|---|
| `/` | Edit an agent's configuration or switch to Test mode to query and verify it |
...
backend/
  app/
    ...
    infrastructure/
      ...
      mcp_client.py           Managed-agent MCP discovery client
...
tests/
  backend/                    End-to-end agent and API tests
```
